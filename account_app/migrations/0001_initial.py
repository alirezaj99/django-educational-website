# Generated by Django 3.2.5 on 2021-12-26 21:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_number', models.CharField(blank=True, max_length=11, null=True, unique=True, validators=[django.core.validators.RegexValidator(flags=0, message='شماره موبایل نامعتبر است.', regex='^[0][9]\\d{9}$')], verbose_name='شماره موبایل')),
                ('web_site', models.URLField(blank=True, null=True, verbose_name='آدرس وب سایت')),
                ('bio', models.TextField(blank=True, max_length=700, null=True, verbose_name='بیوگرافی')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to=account_app.models.upload_avatar_path, verbose_name='تصویر آواتار')),
