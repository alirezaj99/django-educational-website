...
from .views import (
    ...
    ,PasswordReset,PasswordResetConfirm,ProfileUpdate,BlogUpdate,CourseUpdate,VideoList,checkout,apply_coupon_code,remove_coupon_code
)
...
urlpatterns = [
    ...
    path('remove-coupon-code/', remove_coupon_code, name='remove_coupon_code'),
